...
- **Hand-Drawn Sketching**: Rectangles, diamonds, ellipses, lines, arrows, freehand drawings, text, and image pasting.
- **Dual-Mode Workflow**:
...
- **Keyboard Shortcuts & Clipboard**: `Ctrl+C`, `Ctrl+V`, `Ctrl+X`, `Ctrl+Z`, `Ctrl+Y`, `Ctrl+D`, nudge with arrow keys, and quick tool keys (`V`, `R`, `D`, `O`, `A`, `L`, `P`, `T`, `E`).
...
| **`Ctrl + V`** | Paste element(s) (or pasted images) |
