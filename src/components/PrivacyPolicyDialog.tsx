...
export const PrivacyPolicyDialog: React.FC<PrivacyPolicyDialogProps> = ({ isOpen, onClose }) => {
  useEffect(() => {
    if (!isOpen) return;
      ...
      >
        ...
        <div className="flex items-center justify-between pb-4 border-b border-neutral-100 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="privacy-dialog-title" className="text-base font-semibold leading-tight text-neutral-900">
                Privacy Policy
              </h2>
        ...
        <div className="overflow-y-auto py-4 pr-1 space-y-3.5 text-xs text-neutral-600 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-neutral-200 [&::-webkit-scrollbar-thumb]:rounded-full">
          ...
          <div className="p-3.5 rounded-2xl bg-neutral-50 border border-neutral-200/70 space-y-1.5">
            ...
            <p className="leading-relaxed text-neutral-600">
              Canvas Wallpaper (PaperTab) does <strong>not</strong> collect, track, store, or sell any personal data, browsing history, or analytics. Everything you draw, sketch, or configure is saved strictly on your local device via <code className="px-1 py-0.5 bg-neutral-200/70 rounded text-[11px] font-mono text-neutral-800">chrome.storage.local</code>.
            </p>
          ...
          <div className="p-3.5 rounded-2xl bg-neutral-50 border border-neutral-200/70 space-y-1.5">
            ...
            <p className="leading-relaxed text-neutral-600">
              The extension has zero background servers. The only network requests are initiated directly by you:
            </p>
            <ul className="list-disc pl-4 space-y-1 text-neutral-600 leading-relaxed">
              <li>
                <strong>Web Search:</strong> Submitting a query navigates directly to your chosen provider (Google, DuckDuckGo, Bing, or Brave Search).
              </li>
              <li>
                <strong>Quick Link Icons:</strong> Shortcut tiles fetch website favicons via Google's public favicon service. No user identity is attached.
              </li>
            </ul>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-neutral-50 border border-neutral-200/70 space-y-1.5">
            ...
            <p className="leading-relaxed text-neutral-600">
              <code className="px-1 py-0.5 bg-neutral-200/70 rounded text-[11px] font-mono text-neutral-800">storage</code> &amp; <code className="px-1 py-0.5 bg-neutral-200/70 rounded text-[11px] font-mono text-neutral-800">unlimitedStorage</code> are used exclusively to save your drawings, scenes, and custom wallpaper images without browser quota limits.
            </p>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-neutral-50 border border-neutral-200/70 space-y-1.5">
            ...
            <p className="leading-relaxed text-neutral-600">
              Optional premium upgrades in the future will be processed through certified, industry-standard payment processors (such as Stripe or Chrome Web Store Payments). The extension never handles or stores credit card numbers or financial credentials.
            </p>
          </div>
        </div>
